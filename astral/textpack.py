...
#
# This is a *starter*; you can swap in ANS/Huffman later while keeping the container the same.
import re

BASE_LEXICON = [
    "the", "and", "to", "of", "a", "in", "that", "is", "for", "on", "with", "as", "are", "it", "this", "we",
    "you", "be", "or", "by", "from", "at", "not", "have", "can", "will", "your", "our", "all", "data",
    "message", "status", "command", "satellite", "system", "link", "time", "error", "ok", "yes", "no",
    "please", "ack", "nack", "update", "point", "battery", "power", "mode", "safe", "normal", "low",
    "high", "north", "south", "east", "west", "deploy", "arm", "disarm", "reboot", "reset", "start",
    "stop", "record", "science", "image", "voice", "text", "hello", "world", "nominal", "warning"
]
