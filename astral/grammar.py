...
def encode_payload(msg: dict) -> bytes:
    ...
    write_signed_bits(lat, 25)
    write_signed_bits(lon, 25)
...
def decode_payload(b: bytes) -> dict:
    ...
    try:
        ...
        lat_q = read_signed_bits(25)
        lon_q = read_signed_bits(25)
...
def parse_gist(gist_bytes: bytes, gist_bits: int) -> dict:
    ...
    inv_type = {1: "DETECT", 2: "STATUS", 3: "TEXT", 4: "VOICE", 5: "CMD", 6: "CMD_BATCH"}
